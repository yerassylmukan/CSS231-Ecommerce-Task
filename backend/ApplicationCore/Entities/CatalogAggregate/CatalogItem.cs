...
public class CatalogItem : BaseEntity
{
    ...
    public CatalogItem(int catalogTypeId, int catalogBrandId, string name, string description, decimal price, string pictureUrl, int initialStock)
    {
    ...
    public void DecreaseStock(int quantity)
    {
        ...
        if (StockQuantity < quantity) throw new InvalidOperationException("Insufficient stock to complete the operation.");
